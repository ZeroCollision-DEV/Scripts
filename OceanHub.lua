...
menu.bg.pre.Text = 'Ocean<font color="#1e90ff">.vip</font> - By Jumbo Jelly'
local library = {cheatname = "";ext = "";gamename = "";colorpicking = false;tabbuttons = {};tabs = {};options = {};flags = {};scrolling = false;notifyText = Drawing.new("Text");playing = false;multiZindex = 200;toInvis = {};libColor = Color3.fromRGB(30, 144, 255);disabledcolor = Color3.fromRGB(233, 0, 0);blacklisted = {Enum.KeyCode.W,Enum.KeyCode.A,Enum.KeyCode.S,Enum.KeyCode.D,Enum.UserInputType.MouseMovement}}
    ...
    function tab:createGroup(pos,groupname) -- newTab[pos == 0 and "left" or "right"] 
        ...
        function group:addToggle(args)
            ...
            function toggle:addKeybind(args)
                ...
                button.BackgroundColor3 = Color3.fromRGB(0, 119, 182)
                button.BackgroundTransparency = 1.000
                button.BorderSizePixel = 0
            ...
            function toggle:addColorpicker(args)
                ...
                mid.BackgroundColor3 = Color3.fromRGB(0, 119, 182)
                mid.BorderColor3 = Color3.fromRGB(30,30,30)
                mid.BorderSizePixel = 2
                ...
                front.Name = "front"
                front.Parent = mid
                front.BackgroundColor3 = Color3.fromRGB(30, 144, 255)
                front.BorderColor3 = Color3.fromRGB(0, 0, 0)
                ...
                picker.Name = "picker"
                picker.Parent = main
                picker.BackgroundColor3 = Color3.fromRGB(30, 144, 255)
                ...
                hue.Name = "hue"
                hue.Parent = main_2
                hue.BackgroundColor3 = Color3.fromRGB(0, 119, 182)
...
function library:createConfig()
    ...
    writefile("OceanCFGS/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    local name = library.flags["selected_config"]
    if not isfile("OceanCFGS/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("OceanCFGS/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("OceanCFGS") do
        table.insert(tbl,v)
    end
...
function library:deleteConfig()
    if isfile("OceanCFGS/"..library.flags["selected_config"]..".cfg") then
        delfile("OceanCFGS/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
...
othersettings:addToggle({text = "Show Keybinds",flag = "show keybinds"})
